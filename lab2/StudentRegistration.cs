...
namespace laboratory_2_v3
{
    internal class StudentRegistration
    {
        ...
        public void GetAllEnlistedStudents()
        {
            ...
            {
                Console.WriteLine($"{enlisted.Key.Value.FullName,-50} {enlisted.Value.SchoolYr,-50} {GetCourseCount(enlisted.Key.Key)}");
            }
        ...
        public void GetStudentRegistration(int studentId)
        {
            ...
            Console.WriteLine($"""
                ...
                {selectedStudent.Value.FullName,-70} {selectedEnlistment.Program}, Year {selectedEnlistment.YrLevel}
                ============================================================================================================================================
            ...
            foreach (Registration registerEntry in studentRegistration)
            {
                ...
                string courseId = registerEntry.CrsEntry.CrsIdentifier;
                string description = registerEntry.CrsEntry.CrsDesc;
        ...
        public void AddToEnlistment(int studentId, int schoolYear, string semester, string program, int yearLevel)
        {
            try
            {
                ...
                newEntry.SchoolYr = schoolYear;
                newEntry.YrLevel = yearLevel;
